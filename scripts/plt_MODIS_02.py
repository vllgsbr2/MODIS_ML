...
def prepare_data(filename, fieldname, rad_or_ref):
    ...
    return rad_ref
#use this function when you have a single 1km hdf file
...
#use this function if you have the bands in advanced
def plt_RGB_database(b1, b3, b4, rad_or_ref, plot=True):
    '''
    INPUT
          filename:        - string     , filepath to file
          fieldnames_list: - string list, contains 500m res and 250m reshape
